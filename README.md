...
> **使用须知（少踩坑）**
> - 下方「提示词」只对**能跑命令的 AI**（Claude Code / OpenClaw 等带 lark-cli 的环境）有效；发给网页版 ChatGPT / 飞书里的 AI 没用。
> - AI 自动搞定**最难的部分**：装 lark-cli + 飞书授权。**Obsidian 里装 BRAT、Add plugin、启用插件这几下是图形界面，要你自己点**。
> - 装好后维护者每发新版，BRAT 会**自动更新**，你不用再管。
